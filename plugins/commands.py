...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/HD10UPDATES')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/HD10UPDATES'),
            InlineKeyboardButton('Series Club ⭕️', url='https://t.me/HD10SERIES')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/hd10updates'),
            InlineKeyboardButton('Series Club ⭕️', url='https://t.me/HDSERIES')
            ],[
            InlineKeyboardButton('❌ Close the Menu ❌', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support', url='https://t.me/HD10SERIES'),
            InlineKeyboardButton('Channel ⭕️', url='https://t.me/HD10SERIES')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://T.ME/HD10SERIES')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
